...
# file load label
Label(lui_gui_window, text="Graph:", fg="black", bg="lightgrey", width=node_width, font="Verdana 14 bold").grid(row=0, column=3, sticky=W)
...
Label(lui_gui_window, text="Username:", fg="black", bg=node_color, font="Verdana 10 italic", width=node_width).grid(row=6, column=node_column, sticky=W)
node1_credentials_user = Entry(lui_gui_window, width=node_width*2, bg=node_color)
node1_credentials_user.grid(row=7, column=node_column, sticky=W)
Label(lui_gui_window, text="Password:", fg="black", bg=node_color, font="Verdana 10 italic", width=node_width).grid(row=8, column=node_column, sticky=W)
node1_credentials_pass = Entry(lui_gui_window, width=node_width*2, bg=node_color)
node1_credentials_pass.grid(row=9, column=node_column, sticky=W)
...
node1_target_entry = Entry(lui_gui_window, width=node_width*2, bg=node_color)
node1_target_entry.insert(END, '  s3://')
node1_target_entry.grid(row=12, column=node_column, sticky=W) #note: cannot combine these together functionally, or the Entry will return None
...
node3_target_entry = Entry(lui_gui_window, width=node_width*2, fg="white", bg=node_color)
node3_target_entry.insert(END, '  >')
node3_target_entry.grid(row=8, column=node_column, sticky=W)
...
node4_target_entry = Entry(lui_gui_window, width=node_width*2, bg=node_color)
node4_target_entry.insert(END, '  >')
node4_target_entry.grid(row=8, column=node_column, sticky=W)
...
node5_target_entry = Entry(lui_gui_window, width=node_width*2, bg=node_color)
node5_target_entry.insert(END, '  ../')
node5_target_entry.grid(row=8, column=node_column, sticky=W)
